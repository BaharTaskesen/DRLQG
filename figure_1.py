...
from utils.sdp_solution_ext import sdp_solver
import pymanopt
import time
...
for rep in tqdm(range(replications)):
    ...
    np.save("res_mosek_solver_time_n_{}_{}_set_reps_{}".format(n, amb_set, replications), mosek_solver_time_reps)
    fw_solver_time_reps[:, rep] = fw_solver_time
    np.save("res_fw_solver_time_n_{}_{}_set_reps_{}".format(n, amb_set, replications), fw_solver_time_reps)